  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Dragun s'appuie sur Twilio, qui exige un identifiant d'expéditeur enregistré (10DLC aux É.-U.) et fait respecter les listes de mots-clés de désinscription (STOP, ARRÊT, UNSUBSCRIBE) à l'échelle réseau.",
      ],
    },
    {
      heading: "Appels vocaux et enregistrement",
      body: [
        "Un appel automatisé exécuté par Dragun joue un message vocal préenregistré ou synthétisé par votre fournisseur Twilio. Aucun appel n'est enregistré par Dragun.",
    ...
    },
    {
      ...
      body: [
        ...
        "Twilio Inc. — passerelle SMS et voix (États-Unis).",
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Dragun runs on Twilio, which requires a registered sender ID (10DLC in the US) and enforces opt-out keyword lists (STOP, ARRÊT, UNSUBSCRIBE) network-wide.",
      ],
    },
    {
      heading: "Voice calls and recording",
      body: [
        "An automated call placed by Dragun plays a pre-recorded or synthesized voice message via your Twilio account. No call is recorded by Dragun.",
    ...
    },
    {
      ...
      body: [
        ...
        "Twilio Inc. — SMS and voice gateway (United States).",
